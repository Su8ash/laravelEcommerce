                                    ...
                                    <div class="col-xl-3 col-lg-4 col-md-4 col-12">
                                        <div class="single-product">
                                            <div class="product-img">
                                                <a href="product-details\{{$productItem -> id}}">
                                                    <img class="default-img" src="{{$productItem -> image}}" alt="#">
                                                    <img class="hover-img" src="{{$productItem -> image}}" alt="#">
                                                </a>
                                            ...
                                            <div class="product-content">
                                                <h3><a
                                                        href="product-details\{{$productItem -> id}}">{{$productItem -> name}}</a>
                                                </h3>

                                                <h3><a
                                                        href="category\{{$productItem -> category -> id}}">{{$productItem -> category -> name}}</a>
                                                </h3>
                                                <div class="product-price">
                                                    <span>Rs. {{$productItem -> price}}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
